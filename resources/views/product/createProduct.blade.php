        ...
        <div class="panel-body">
            ...
            <form action="{{ url('add_product') }}" role="form" id="form1" method="post" class="validate" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" id="price" data-validate="required" data-message-required="This is custom message for required field." placeholder="Required Field" />
                </div>
                <div class="form-group">
                    ...
                    <select data-placeholder="Select categories" multiple class="chosen-select" name="category[]" id="category">
